import { Box, Center, HStack, Heading, VStack, Image, Text, Badge } from "native-base";
    ...
    return (
        <Center>
            <VStack safeArea py="1" w="100%" maxW="380" space={8}>
                ...
                <Center>
                    <Text underline fontWeight="bold" fontSize='xs' color={["orange.600"]} letterSpacing="xs">You are all caught up!</Text>
                </Center>
            </VStack>
        </Center>
    );
